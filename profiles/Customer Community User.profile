...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <layoutAssignments>
        <layout>ReturnOrderItemAdjustment-Présentation Ajustement d%27article de commande de retour</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ReturnOrderItemTax-Présentation Taxe sur les articles de commande de retour</layout>
    </layoutAssignments>
    <layoutAssignments>
